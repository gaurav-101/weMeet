...
const createPeerConnection = () => {
  ...
  if (
    ...
    document.getElementById("local_video_container").classList.remove('display_none');
    document.getElementById("local_video").classList.remove('display_none');
...
export const handleHangUp = () => {
  ...
  wss.sendUserHangedUp(data);
  closePeerConnectionAndResetState();
  document.getElementById("local_video_container").classList.add('display_none');
  document.getElementById("local_video").classList.add('display_none');
};
